      ...
      <div className="py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:mt-0 md:order-1">
          <div className="flex items-center justify-center md:justify-start">
            <ChessKnight className="h-6 w-6 text-purple-400" />
            <span className="ml-2 text-lg font-semibold text-white">ChessMaster</span>
          </div>
          <p className="mt-2 text-center md:text-left text-base text-gray-400">
            &copy; 2023 ChessMaster. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
